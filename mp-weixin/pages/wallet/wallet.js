  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return {
        ...
        f: common_vendor.sr(investPopupRef, "ae511152-1", {
          "k": "investPopupRef"
        }),
        g: common_vendor.p({
          position: "bottom"
        }),
        h: common_vendor.sr("customAmountDialogRef", "ae511152-3,ae511152-2"),
        ...
        k: common_vendor.sr(customAmountPopupRef, "ae511152-2", {
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "D:/ListenToBooks-master/pages/wallet/wallet.vue"]]);
