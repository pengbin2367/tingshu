...
public class WxPayApiController {
    ...
    public String getWxPayUrl(@RequestParam String body, @RequestParam String orderNo, @RequestParam String money) {
        return wxPayService.getWxPayUrl(body, orderNo, money);
    }
...
//        inputStream.close(); outputStream.close();
        ...
        Map map = JSONObject.parseObject(resultString, Map.class);
